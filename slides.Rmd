...
#whats is school and country data
...
```{r score-differences, fig.cap ="Gender Gap Scores", fig.width=12, fig.height=10, fig.align='center', out.width=690}
...
```{r corr-plot, fig.cap ="Scatrplot", fig.width=9, fig.height=5, fig.align='center'}
p1+p2+p3
```
...
```{r qual-plot, fig.cap ="Qual Plots", fig.width=9, fig.height=9, fig.align='center'}
...
```{r compint-plot, fig.cap ="Computers and the Internet", fig.width=8, fig.height=6, fig.align='center',}
...
```{r bs-plot, fig.cap ="Temporal patterns", fig.height=9, fig.width=12, fig.align='center'}
all_bs_cf <- all_bs_cf %>%
